...
public class MyExceptionHandler implements UncaughtExceptionHandler
{
	...
	public void collectDeviceInfo(Context ctx)
	{
		try
		{
			...
			if (pi != null)
			{
				...
				infos.put("deviceName", Build.MODEL);
				infos.put("deviceVersion", Build.VERSION.SDK);
			}
	...
	private String saveCrashInfo2File(Throwable ex) 
	{
		...
		try 
		{
			...
			fos.close();
			emailManager.sendEmail("APP异常_" + DateUtils.getStringDate(), sb.toString(), new String[]{"log@zhunit.com"}, null);
			return fileName;
		} 
		catch (Exception e) 
		{
