...
public class PickViewUtil {
    ...
    public static void alertTimerPicker(Context context, TimePickerView.Type type, final String format, final TimerPickerCallBack callBack) {
        ...
        pvTime.setOnTimeSelectListener(new TimePickerView.OnTimeSelectListener() {
            ...
            public void onTimeSelect(Date date) {
                ...
                pvTime.setTitle(sdf.format(date));
            }
        });
     ...
     * @param click
     */
    public static void alertBottomWheelOption(Context context, ArrayList<?> list,int defaultWeek, final OnWheelViewClick click) {
        ...
        wv_option.setCurrentItem(defaultWeek);
