...
public class AdPlanlistAdapter extends BaseAdapter {
    private List<AdPlanInfo> dataList;
    private OnMoreClickListener listener;
    private boolean isPlaylist=true;

    public AdPlanlistAdapter(List<AdPlanInfo>  dataList) {
        this.dataList = dataList;
    }

    public void notifyDataSetChanged(List<AdPlanInfo>  dataList)
    {
        this.dataList = dataList;
