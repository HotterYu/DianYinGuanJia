...
public class WheelListDialog extends AlertDialog
{
    ...
    public WheelListDialog(@NonNull Context context, List<String> data) {
        super(context, R.style.style_wheel_list_dialog);
        mContext = context;
        this.data = data;
        view = LayoutInflater.from(context).inflate(R.layout.dialog_wheel_list, null);
    }
    ...
    public String getPositionData() {
        ...
        int pos = firstPosition + 3;
        if(pos < showData.size())
            return showData.get(pos);
        else
            return "";
    }
...
//初始化最先显示的数据
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            View view;
            if (convertView == null) {
                view = LayoutInflater.from(mContext).inflate(R.layout.dialog_wheel_list_item,
                        parent, false);
            } else {
                view = convertView;
            }
