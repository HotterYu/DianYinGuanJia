package com.znt.vodbox.view.xlistview;
...
public class LJListView extends RelativeLayout implements OnScrollListener
{
	...
	private int count = 0; //琛ㄧず鏇存柊浜嗗灏戞潯
	...
	@Override
	/**
	 * 閲嶅啓璇ユ柟娉曪紝杈惧埌浣縇istView閫傚簲ScrollView鐨勬晥鏋�
	 */
	...
	private void initWithContext(Context context) 
	{
		...
		mListView = (DragSortListView) LayoutInflater.from(context).inflate(R.layout.ljlistview, null);
	...
	public void stopRefresh() 
	{
		if (mPullRefreshing == true) 
		{
			...
			if(mIsAnimation && isHintEable)
			{
				if(count > 0)
				{
					infoHint.setText(String.format("鏇存柊浜�%s鏉℃暟鎹�", count));
	...
	public void stopLoadMore()
	{
		...
		if(count < Constant.ONE_PAGE_SIZE)//褰撳墠鏇存柊鐨勬暟鎹皬浜庢垨绛変簬涓�椤�
	...
	public void onFresh()
	{
		...
		resetHeaderHeight();
		int finalHeight = StringUtils.dip2px(context, 60);  //XListViewHeader涓殑楂樺害
